...
const FavouriteList = () => {
    ...
    useEffect(() => {
        // Update active index when the board ID changes
    ...
    const onDragEnd = async ({ source, destination }) => {
        ...
        // Update the active index and the favourite list in Redux state
        const activeItem = newList.findIndex((e) => e.id === boardId);
        setActiveIndex(activeItem);
        dispatch(setFavouriteList(newList));

        // Update the favourite list positions on the server
        try {
